...
import com.example.examath.Derivatives
import com.example.examath.PrlistFragment

class DerivativesFragmentAdapter(
    private val imagesList: ArrayList<Derivatives>,
    private val context: PrlistFragment
): RecyclerView.Adapter<DerivativesFragmentAdapter.Holder> (){
